...
<!-- 1.显示评论 -->
<table id="dg" class="easyui-datagrid" title="评论管理" fitColumns="true" fit="true" pagination="true"
	rownumbers="true" url="${ pageContext.request.contextPath }/admin/comment/list.do" toolbar="#tb">
	<thead>
		<tr>
