...
<script type="text/javascript">
	...
	//关闭修改密码对话框
	function closePasswordModifyPassword(){
		resetValue() ;//清空密码
		$("#dlg").dialog("close") ;//关闭对话框
	}
	...
	<table style="padding: 5px" width="100%">
		<tr>
			...
			<td style="padding-top: 16px" valign="middle" align="right" width="50%">
				<font size="3">&nbsp;&nbsp;<strong>欢迎：</strong>朱虚居士</font>
			</td>
		</tr>
	</table>
</div>
...
<div region="west" style="width: 200px" title="导航菜单" split="true">
	<div class="easyui-accordion" data-options="fit:true,border:false">		
		<div title="常用功能"  data-options="iconCls:'icon-home'" style="padding:10px;">
...
<div id="dlg" class="easyui-dialog" style="width:400px;height:200px;padding:10px 20px;" closed="true" buttons="#dlg-buttons">
	<form id="fm" method="post">
		<table cellspacing="8px">
			...
			<tr>
				<td>新的密码：</td>
				<td><input type="password" id="password1" name="password1" class="easyui-validatebox" required="true" style="width:200px;" /></td>
			</tr>
			<tr>
				<td>确认密码：</td>
				<td><input type="password" id="password2" name="password2" class="easyui-validatebox" required="true" style="width:200px;" /></td>
			</tr>
		</table>
	</form>
</div>
...
<div id="dlg-buttons">
	...
	<a href="javascript:closePasswordModifyPassword();" class="easyui-linkbutton" iconCls="icon-cancel">关闭</a>
</div>
</body>
</html>