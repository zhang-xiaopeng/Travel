...
/**重新加载验证码*/
function loadimage(){
	document.getElementById("randImage").src="${pageContext.request.contextPath}/image.jsp?"+new Date().getTime();
}
				...
				<c:otherwise>
					<form id="queryForm" action="${pageContext.request.contextPath}/blog/q.html" method="post">
						...
						<c:forEach var="keyword" items="${keywords}">
							&nbsp;&nbsp;<a target="_blank" href="javascript:query1('${keyword}')" >${keyword}</a>&nbsp;&nbsp;
						</c:forEach>
